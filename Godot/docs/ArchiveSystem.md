...
> 适用版本：Godot 4.6.2 + .NET 8 ｜ 对应代码：`Framework/GodotGameFrameworkCore/Archive/ArchiveSystem.cs`、`Framework/GodotGameFrameworkCore/Json/EasySave.cs`、`TheGame/GameScripts/Archive/GameData.cs`
